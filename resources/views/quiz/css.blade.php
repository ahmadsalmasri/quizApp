...
<div class="row" id="VueApp">
    <div class="col-md-12">
        <div>
            <form method="POST" action="{{ route('cssQuizAction') }}" enctype="multipart/form-data" onsubmit="return false;">
                @csrf
                <ol>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-primary" v-on:click="getanswer()">Finish</button>
                    </div>
                </div>
            </form>
        </div>
