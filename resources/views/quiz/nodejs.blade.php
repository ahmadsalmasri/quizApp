    ...
    <div class="col-md-12">
        <div>
            <form method="POST" action="{{ route('nodejsQuizAction') }}" enctype="multipart/form-data">
                @csrf
                <ol>
                    <li style="color: blueviolet;">What is the purpose of the package.json file in a Node.js project ?</li>
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the app.use() method in Express.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the require() function in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">How do you include the HTTP module in a Node.js file ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which of the following is NOT a valid way to read environment variables in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to parse JSON data in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the crypto module in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to read environment variables from a .env file ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to create an HTTP server in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">NPM is a</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which module would you use to create a child process in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which of the following is NOT a valid stream event in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">How do you access query parameters in an Express.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to redirect a response in Express.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the path.join() method in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to read a file synchronously in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the node_modules folder ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which method is used to handle GET requests in Express.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which of the following best describes the architecture of Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which of the following is NOT a valid HTTP method in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">The Node.js Event Loop is responsible for making Node.js:</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the events module in Node.js ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which command is used to install all dependencies listed in package.json ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">Which module would you use to work with file paths in a cross-platform way ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li style="color: blueviolet;">What is the purpose of the util.promisify() method in Node.js ?</li>
                    <ul style="list-style-type:none">
