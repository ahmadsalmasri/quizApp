    ...
    <div class="col-md-12">
        <div>
            <form method="POST" action="{{ route('bootstrapQuizAction') }}" enctype="multipart/form-data">
                @csrf
                <ol>
                     <li>Which class provides a responsive fixed width container ?</li>
                    ...
                    <hr>
                    <li>Which class shapes an image to a circle ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class is used to create a basic list group ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>The .container class provides a full width container, spanning the entire width of the screen</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>Which class is used to create a loader ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>A standard navigation tab is created with:</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>A standard navigation bar is created with:</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>Which contextual class indicates a succesful or positive action ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>Which class is used to create a badge ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>Which class is used to create a big box for calling extra attention ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                     <li>Which class can be used to float an element to the right of the page ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which button class is used to create a large button ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class adds zebra-stripes to a table ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class indicates a dropdown menu ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class is used to create a button group ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which component is used to cycle through elements, like a slideshow ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>The Bootstrap grid system is based on how many columns ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which attribute is used to create a tooltip ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class is used to create a vertical navigation bar ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class is used to style a close icon ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which contextual class is used to create an orange text color ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class is used to create a basic pagination ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which contextual class indicates a dangerous or potentially negative action ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class adds a heading to a card ?</li>
                    <ul style="list-style-type:none">
                    ...
                    <hr>
                    <li>Which class indicates uppercased text ?</li>
                    <ul style="list-style-type:none">
